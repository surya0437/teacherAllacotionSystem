...
{               ?>
        ...
        <input type="text" class="form-control border-none input-flat bg-ash" value="<?php  echo htmlentities($row->FacultyName);?>" name="coursename" required="true">
                                            </div>
                                        </div>
                                        <!-- <div class="basic-form m-t-20">
                                            <div class="form-group">
