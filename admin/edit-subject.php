                                                    ...
                                                    <div class="basic-form m-t-20">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control border-none input-flat bg-ash" name="cid">
                                                                <option value="<?php echo htmlentities($row->cid); ?>"><?php echo htmlentities($row->CourseName); ?></option>
                                                                <?php
                                                                ...
                                                                if ($query->rowCount() > 0) {
                                                                    foreach ($results as $row1) {               ?>
                                                                        <option value="<?php echo htmlentities($row1->ID); ?>"><?php echo htmlentities($row1->CourseName); ?></option><?php $cnt = $cnt + 1;
                                                                                                                                                                                                                                    }
                                                                                                                                                                                                                                } ?>
                                                            </select>
                                                        </div>
